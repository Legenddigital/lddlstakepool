...
import (
	...
	"github.com/Legenddigital/lddlstakepool/helpers"
	"github.com/Legenddigital/lddlstakepool/models"
	"github.com/Legenddigital/lddlstakepool/poolapi"
	"github.com/Legenddigital/lddlstakepool/stakepooldclient"
...
// which is a problem since there is no testnet3.Legenddigital.org host.
...
func (controller *MainController) APIAddress(c web.C, r *http.Request) ([]string, codes.Code, string, error) {
	...
	p, err := lddlutil.DecodeAddress(poolPubKeyAddr)
	if err != nil {
	...
	createMultiSig, err := controller.rpcServers.CreateMultisig(1, []lddlutil.Address{p, u})
	if err != nil {
...
func (controller *MainController) FeeAddressForUserID(uid int) (lddlutil.Address,
	error) {
	if uid+1 > MaxUsers {
...
func (controller *MainController) TicketAddressForUserID(uid int) (lddlutil.Address,
	error) {
	if uid+1 > MaxUsers {
		return nil, fmt.Errorf("bad uid index %v", uid)
	}
...
func (controller *MainController) WalletStatus() ([]*lddljson.WalletInfoResult, error) {
...
func (controller *MainController) Address(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Legenddigital Stake Pool - Address"
...
func (controller *MainController) AddressPost(c web.C, r *http.Request) (string, int) {
	...
	// Get lddlutil.Address for user from pubkey address string
	u, err := lddlutil.DecodeAddress(userPubKeyAddr)
	if err != nil {
...
func (controller *MainController) AdminStatus(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Legenddigital Stake Pool - Status (Admin)"
...
func (controller *MainController) AdminTickets(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Legenddigital Stake Pool - Tickets (Admin)"
	c.Env["Content"] = template.HTML(widgets)
...
func (controller *MainController) EmailUpdate(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Legenddigital Stake Pool - Email Update"
	c.Env["Content"] = template.HTML(widgets)
...
func (controller *MainController) EmailVerify(c web.C, r *http.Request) (string,
	...
	c.Env["Title"] = "Legenddigital Stake Pool - Email Verification"
	c.Env["Content"] = template.HTML(widgets)
...
func (controller *MainController) Error(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Admin"], _ = controller.isAdmin(c, r)
	c.Env["IsError"] = true
	c.Env["Title"] = "Legenddigital Stake Pool - Error"
	c.Env["RPCStatus"] = rpcstatus
...
func (controller *MainController) Index(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Admin"], _ = controller.isAdmin(c, r)
	c.Env["IsIndex"] = true
	c.Env["Title"] = "Legenddigital Stake Pool - Welcome"
	c.Env["Content"] = template.HTML(widgets)
...
func (controller *MainController) PasswordReset(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Legenddigital Stake Pool - Password Reset"
	c.Env["Content"] = template.HTML(widgets)
...
func (controller *MainController) PasswordUpdate(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Legenddigital Stake Pool - Password Update"
	c.Env["Content"] = template.HTML(widgets)
...
func (controller *MainController) Settings(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Legenddigital Stake Pool - Settings"
	c.Env["Content"] = template.HTML(widgets)
...
func (controller *MainController) SignIn(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Legenddigital Stake Pool - Sign In"
	c.Env["Content"] = template.HTML(widgets)
...
func (controller *MainController) SignUp(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Legenddigital Stake Pool - Sign Up"
	c.Env["Content"] = template.HTML(widgets)
...
func (controller *MainController) Stats(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Admin"], _ = controller.isAdmin(c, r)
	c.Env["IsStats"] = true
	c.Env["Title"] = "Legenddigital Stake Pool - Stats"
...
func (controller *MainController) Tickets(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Network"] = controller.getNetworkName()
	c.Env["PoolFees"] = controller.poolFees
	c.Env["Title"] = "Legenddigital Stake Pool - Tickets"
	...
	// Get P2SH Address
	multisig, err := lddlutil.DecodeAddress(user.MultiSigAddress)
	if err != nil {
...
func (controller *MainController) Voting(c web.C, r *http.Request) (string, int) {
	...
	c.Env["Title"] = "Legenddigital Stake Pool - Voting"
	c.Env["Content"] = template.HTML(widgets)
