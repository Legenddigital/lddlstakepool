...
//
// TODO Document gRPC API like lddlwallet once the API is stable
package rpcserver
...
import (
	...
	pb "github.com/Legenddigital/lddlstakepool/backend/stakepoold/rpc/stakepoolrpc"
...
const (
	...
	// error message in this case before lddlstakepool applies a client timeout.
